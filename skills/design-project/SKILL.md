...
The mentor announces the shift from Socratic to didactic mode. Per SOUL, this announcement matters because *"asking Socratic questions about methods and papers you have not yet been taught would be unfair."* The mode shift announced here covers all the didactic work across this skill — methodology selection (Phase 3), reference-article handling (Phase 3 collection work and Phase 4 consolidation), and the writing-model demonstration in Phase 5.
