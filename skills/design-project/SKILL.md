...
**Last edited:** 2026-06-04 (Cowork — open items 1 and 3 resolved per educator decisions: Type 2 exemplar set authored as `references/type-2-exemplars.md`; qualitative-transition register (educator-chosen blend) written into Phase 3g with governing constraints)
